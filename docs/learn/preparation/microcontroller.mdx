...
:::info
There are many popular microcontroller boards like Arduino, MicroPython... Each one uses a different language and has its advantages. And our boards (SwiftIO Micro or SwiftIO board) use the Swift language.
