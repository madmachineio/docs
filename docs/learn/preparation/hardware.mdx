...
description: Take a quick look at the hardware for the tutorials. 
---
...
The shield in the middle of the kit is for easier connection, and it's the SwiftIO Feather board that communicates with all the modules. After you plug the SwiftIO Feather board into the shield, the circuit is built. Then you could program the SwiftIO Feather board to control the modules. 
