...
<img src={require('./img/micro.png').default} alt="SwiftIO Micro" width="480" />

* SwiftIO Playground - expansion board
<img src={require('./img/playground.png').default} alt="SwiftIO playground" width="960" />
...
<img src={require('./img/microParts.png').default} alt="Parts of Micro" width="960" />
...
| I2S      | 1 (I2S0), SYNC, BCLK and RX/TX pins used for I2S audio input                     |
...
<img src={require('./img/microPinout.png').default} alt="Pinout of Micro" width="960" />
...
<img src={require('./img/playgroundPins.png').default} alt="playground module connection" width="720" />
...
<img src={require('./img/plugMicro.png').default} alt="Plug SwiftIO Micro to the shield" width="960" />
...
<img src={require('./img/disassembledParts.png').default} alt="Each part of playground" width="960" />
...
<img src={require('./img/disassemble.png').default} alt="Disassemble the kit" width="360" />
