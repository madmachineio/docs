...
1. Insert the SD card into the SwiftIO Feather board.

<img
  src={require('./img/insertSDCard.png').default}
  alt="Insert SD card to board" width="480"
/>

2. **Connect** your SwiftIO Feather board to your computer using a USB cable.
...
:::info
If you are using our **prototype board** that has a LiPo battery connector, there is one more shield board in between. Make sure to connect the USB port on the shield to your computer for code downloading instead of the other two ports.
:::
