...
Download the **[mm-sdk](https://github.com/madmachineio/mm-sdk/releases/tag/0.9.0-alpha.3)** according to your operating system. This sdk is used to build and download your project.
