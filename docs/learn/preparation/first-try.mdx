...
2. **Install the extension** as shown below:
...
3. **Download the latest [mm-sdk](https://github.com/madmachineio/mm-sdk/releases)**. It is used to build and download your project.
...
5. Click **Extensions** to expand it and find **MadMachine**. Indicate the **mm-sdk location** in the box that matches your operating system. If you change the location of sdk later, you will need to update it. 
...
2. Click the **Build** button to build your project.
