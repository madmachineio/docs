...
**[`DigitalIn`](https://madmachineio.github.io/SwiftIO/documentation/swiftio/digitalin)** - this class allows you to get the current state of a specified input pin.
...
You can download the project source code [here](https://github.com/madmachineio/MadExamples/tree/main/Examples/SwiftIOPlayground/01CommonPeripherals/02Button/MomentaryLEDSwitch).

```swift title="MomentaryLEDSwitch.swift" showLineNumbers
// Import the SwiftIO library to control input and output and the MadBoard to use the id of the pins.
import SwiftIO
import MadBoard

@main
public struct MomentaryLEDSwitch {
...
You can download the project source code [here](https://github.com/madmachineio/MadExamples/tree/main/Examples/SwiftIOPlayground/01CommonPeripherals/02Button/ButtonInterrupt).

```swift title="ButtonInterrupt.swift" showLineNumbers
// Import the SwiftIO library to control input and output and the MadBoard to use the id of the pins.
import SwiftIO
import MadBoard

@main
public struct ButtonInterrupt {
    public static func main() {
...
You can download the project source code [here](https://github.com/madmachineio/MadExamples/tree/main/Examples/SwiftIOPlayground/01CommonPeripherals/02Button/ToggleLEDSwitch).

```swift title="ToggleLEDSwitch.swift" showLineNumbers
...
You can download the project source code [here](https://github.com/madmachineio/MadExamples/tree/main/Examples/SwiftIOPlayground/01CommonPeripherals/02Button/TwoWayLEDSwitches).

```swift title="TwoWayLEDSwitches.swift" showLineNumbers
...
@main
public struct TwoWayLEDSwitches {
    public static func main() {
...
You can download the project source code [here](https://github.com/madmachineio/MadExamples/tree/main/Examples/SwiftIOPlayground/01CommonPeripherals/02Button/OnOffButtons).

```swift title="OnOffButtons.swift" showLineNumbers
