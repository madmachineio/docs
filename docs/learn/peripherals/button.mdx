...
Like digital output, digital input has two states: high and low. When an input signal comes in, its voltage will be compared with specific thresholds. If the voltage is higher than the threshold, it's high, and if it's lower, it's low. You can regard it as a multimeter used to measure voltage, but only has two results.
...
* When the button is **released**/not pressed, the LED stays **off**.
* After you **press** the button, the LED turns **on**.
* If you **hold**/keep pressing the button, the LED stays **on**.
* Once you **release** the button, the LED turns **off**.


| Button | released | pressed | hold | released | ... |
| ------ | -------- | ------- | ---- | -------- | --- |
| LED    | off      | on      | on   | off      | ... |
...
* When you **hold or release** the button, the LED state remains **unchanged**.
* If you **press** the button again, the LED turns **off** immediately.


| Button | released | pressed | hold | released | pressed | hold | released | ... |
| ------ | -------- | ------- | ---- | -------- | ------- | ---- | -------- | --- |
| LED    | off      | on      | on   | on       | off     | off  | off      | ... |
...
* When the button is **released**/not pressed, the LED stays **off**.
* If you **press** the button, the LED stays **off**.
* When you **hold** the button, the LED stays **off**.
* After you **release** the button, the LED turns **on**.
* After you **press + release** the button again, the LED turns **off**.

| Button | released | pressed | hold | released | pressed | hold | released | ... |
| ------ | -------- | ------- | ---- | -------- | ------- | ---- | -------- | --- |
| LED    | off      | off     | off  | on       | on      | on   | off      | ... |
...
* When both two buttons are **released**/not pressed, the LED stays off.
* After any of the two buttons (D1, D21) are **pressed and then released**, the LED turns **on**.
* After any of the two buttons (D1, D21) are **pressed and then released again**, the LED turns **off**.
...
The situation when two buttons are pressed at the same time is not considered.
