...
You can download the project source code [here](https://github.com/madmachineio/MadExamples/tree/main/Examples/SwiftIOPlayground/01CommonPeripherals/07Accelerometer/Accelerometer).
...
<Tabs
  defaultValue="main"
  values={[
    { label: 'Accelerometer.swift', value: 'main', },
...
You can download the project source code [here](https://github.com/madmachineio/MadExamples/tree/main/Examples/SwiftIOPlayground/01CommonPeripherals/07Accelerometer/AccelerometerDice).

<Tabs
  defaultValue="main"
  values={[
    { label: 'AccelerometerDice.swift', value: 'main', },
    { label: 'Package.swift', value: 'package', },
  ]
}>
...
let package = Package(
    ...
    targets: [
        ...
        .testTarget(
            name: "AccelerometerDiceTests",
            dependencies: ["AccelerometerDice"]),
    ]
)
```
</TabItem>
...
You can download the project source code [here](https://github.com/madmachineio/MadExamples/tree/main/Examples/SwiftIOPlayground/01CommonPeripherals/07Accelerometer/AccelerometerLock).

<Tabs
  defaultValue="main"
  values={[
    { label: 'AccelerometerLock.swift', value: 'main', },
    { label: 'Package.swift', value: 'package', },
  ]
}>
...
let package = Package(
    ...
    targets: [
        ...
        .testTarget(
            name: "AccelerometerLockTests",
            dependencies: ["AccelerometerLock"]),
    ]
)
```
</TabItem>
