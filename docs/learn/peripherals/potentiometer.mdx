...
You can download the project source code [here](https://github.com/madmachineio/MadExamples/tree/main/Examples/SwiftIOPlayground/01CommonPeripherals/04Potentiometer/Potentiometer).
...
You can download the project source code [here](https://github.com/madmachineio/MadExamples/tree/main/Examples/SwiftIOPlayground/01CommonPeripherals/04Potentiometer/PitchControl).

```swift title="PitchControl.swift" showLineNumbers
// Import the SwiftIO to control input and output and the MadBoard to use the pin name.
import SwiftIO
import MadBoard

@main
public struct PitchControl {
    public static func main() {
...
You can download the project source code [here](https://github.com/madmachineio/MadExamples/tree/main/Examples/SwiftIOPlayground/01CommonPeripherals/04Potentiometer/LEDDimmer).

```swift title="LEDDimmer.swift" showLineNumbers
// Import SwiftIO library to control input and output, and MadBoard to use the pin name.
import SwiftIO
import MadBoard

@main
public struct LEDDimmer {
    public static func main() {
        // Initialize the analog pin for the potentiometer and PWM pin for the LED.
        let knob = AnalogIn(Id.A0)
...
You can download the project source code [here](https://github.com/madmachineio/MadExamples/tree/main/Examples/SwiftIOPlayground/01CommonPeripherals/04Potentiometer/LEDBlinkControl).

```swift title="LEDBlinkControl.swift" showLineNumbers
import SwiftIO
import MadBoard
...
You can download the project source code [here](https://github.com/madmachineio/MadExamples/tree/main/Examples/SwiftIOPlayground/01CommonPeripherals/04Potentiometer/DoubleLEDDimmer).

```swift title="DoubleLEDDimmer.swift" showLineNumbers
import SwiftIO
import MadBoard

@main
public struct DoubleLEDDimmer {
    public static func main() {
...
You can download the project source code [here](https://github.com/madmachineio/MadExamples/tree/main/Examples/SwiftIOPlayground/01CommonPeripherals/04Potentiometer/PlayingTones).

```swift title="PlayingTones.swift" showLineNumbers
import SwiftIO
import MadBoard
