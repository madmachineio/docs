...
1. Please **download and install the [driver](https://github.com/WCHSoftGroup/ch34xser_macos)** for the USB-to-SERIAL device on your board.
2. After finishing downloading the project, click **SERIAL MONITOR** tab.
...
3. **Choose the port** of your board. Its name should start with **tty.wchusbserial**.
...
5. Click the button **Start Monitoring**.
...
And now you should see the values printed on after another.

<img
  src={require('./img/printValues.png').default}
  alt="" width="960"
/>
...
```swift title="C01S04LEDBrightnessBlink.swift" showLineNumbers
import SwiftIO
import MadBoard
