...
There are many types of LEDs with different colors and sizes. The LED on your SwiftIO Circuit Playgrounds is a small variant designed to be convenient for mass production. You could see [this article](https://lastminuteengineers.com/light-emitting-diode-led/) for more details on LED.
