...
In this tutorial, you will explore Wi-Fi usage. ESP32 is widely used in all kinds of projects that requires Wi-Fi.


**Learning goals**

* Get a rough idea of how Wi-Fi works.
* Learn to get info from public servers using HTTP requests.
