...
**[`UART`](https://madmachineio.github.io/SwiftIO/documentation/swiftio/uart)** - this class allows you to write and read data via the UART bus.
...
You can download the project source code [here](https://github.com/madmachineio/MadExamples/tree/main/Examples/SwiftIOPlayground/02AdvancedPeripherals/01UART/SerialEcho).

```swift title="SerialEcho.swift" showLineNumbers
...
You can download the project source code [here](https://github.com/madmachineio/MadExamples/tree/main/Examples/SwiftIOPlayground/02AdvancedPeripherals/01UART/SerialLEDSwitch).

```swift title="SerialLEDSwitch.swift" showLineNumbers
    ...
    public static func main() {
        ...
        while true {
            ...
            if count > 0 {
                ...
                // Connect the port on your Micro in serial monitor to see printed message
                print(command)
...
You can download the project source code [here](https://github.com/madmachineio/MadExamples/tree/main/Examples/SwiftIOPlayground/02AdvancedPeripherals/01UART/RemoteLEDSwitch).
