...
* [**Learn about peripherals**](./peripherals/overview): in this section, you will dive deeper into the electronic concepts and get used to programming your board using Swift language. Each tutorial focuses on one main electronic usage. You will experiment with the provided projects to have a better understanding.
