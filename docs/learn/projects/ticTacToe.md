...
You can download the project source code [here](https://github.com/madmachineio/MadExamples/tree/main/Examples/SwiftIOPlayground/13MoreProjects/TicTacToe).
...
<Tabs
  defaultValue="main"
  values={[
    { label: 'TicTacToe.swift', value: 'main', },
