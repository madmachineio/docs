...
Let's play the classic breakout game in this project. Rotate the potentiometer (A0) to move the paddle in order to hit the ball.
...
<Tabs
  defaultValue="main"
  values={[
    { label: 'BreakoutGame.swift', value: 'main', },
