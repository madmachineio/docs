...
2. learn with some example in: 
    * [General](../tutorials/general/getting-started/blink) if you only buy the board and have already all kinds of electronic devices,
    * or [SwiftIO Maker Kit](../tutorials/swiftio-maker-kit/mission1).
