...
In the diagram above, you may notice the pins P0 to P35 are all multiplexed pins and have several usages. They don't have a predefined purpose, hence you need to configure them for a specific purpose through code.
