...
Download the **[mm-sdk](https://github.com/madmachineio/mm-sdk/releases/tag/1.1.0-alpha.9)** according to your operating system and **unzip** it.
...
2. [Download](https://www.swift.org/install/macos) and install the development snapshot **(release/6.1 branch build)** of the Swift toolchain(.pkg), it will install itself to `/Library/Developer/Toolchains`.
...
2. [Download](https://www.swift.org/install/linux/ubuntu/22_04) the development snapshot **(release/6.1 branch build)** of the Swift toolchain(.tar.gz).
