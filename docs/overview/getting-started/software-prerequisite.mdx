...
2. Then come back to the VS code. Click ⚙️ / **Extension Settings** to open the settings.
...
3. Enter the **path of the sdk** in the box that matches your operating system. Windows is not supported since we are waiting for the full Window support of Swift language...
