...
1. **Download** the latest [sdk](https://github.com/madmachineio/mm-sdk/releases) according to your operating system and unzip it.
...
6. The project will open in a new window. Click on the Explorer `Sources` / `main.swift` to open the file. You will always edit the code in the file `main.swift` for your future projects. Copy and paste the following sample code into the file.
...
Click the **Download** button. The IDE begins to build your project and download it to your board if there is no error. 

<img
  src={require('./img/download.png').default}
  alt="Download the code" width="720"
/>
