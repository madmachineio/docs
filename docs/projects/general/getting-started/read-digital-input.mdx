...
print(value)
```
The function `print()` is used to print the values out. You can view them on a serial monitor by connecting the serial port to your computer. Here is a guide to tell you how to [open the serial monitor](../../../../overview/advanced/serial-debug#step-3-open-serial-monitor).
