...
In this tutorial, let's see how to display text on a screen. You can display some specified phrases or sensor's readings 
...
The fonts we talk about later are all bitmap fonts. The two fonts in the example above are built-in fonts. All data of characters are already decoded, like the default font [`RobotRegular16`](https://github.com/madmachineio/MadDisplay/blob/main/Sources/MadDisplay/Font/RobotRegular16.swift), so you can directly use them when creating a label. 
...
You can load the sample font file [`NotoSansSC-Regular-16`](https://github.com/madmachineio/MadDisplay/tree/main/font).
