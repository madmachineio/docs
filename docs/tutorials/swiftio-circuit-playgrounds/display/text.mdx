...
| Method | Explanation |
| ------ | ----------- |
| init(x:y:scale:text:color:font:) | Set the text’s parameters to decide how it looks. <br />**Parameter:**<br />- x and y decide the position of this label. The text will be displayed from the origin by default. Since a label constitutes a group.<br />- scale is inherited from Group and decides the size of text. It keeps the original size by default.<br />- text is what you want to display.<br />- color is the color of the text, white by default.<br />- font decides the typeface of the text. There is a default font for all text. You can also load other pcf font files. |
| updateBackgroundColor(_:) | Set or change the color of the background box. |
| updateText(_:) | Change the text to a new one. |
