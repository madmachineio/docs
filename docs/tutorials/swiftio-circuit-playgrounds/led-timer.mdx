...
You learned about another interrupt triggered by timer in this tutorial. Now you've known two ways of interrupt. As you try more projects, you'll find this mechanism can really reduce a lot of effort when dealing with several time-critical tasks.
