...
In the two previous projects, the LEDs turn on and off automatically. Now, you will control the LED manually using a pushbutton.
...
Ok, the circuit is complete. It is really convenient, isn't it?
