...
description: Learn how to blink the onboard LED and get started with Swift language.
...
## Circuit
Just connect the SwiftIO board to your computer through the download port using a USB cable.
